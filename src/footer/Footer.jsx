...
const Footer = () => {
    ...
    return (
        <footer className="px-4 divide-y bg-nav " >
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                <div className="lg:w-1/3 flex-col items-center mx-auto">
                <Link to={"/"}><div className="flex gap-3 text-2xl rounded-xl p-2  "><img className="w-10 h-10 shadow-lg rounded-md" src="/assets/images/fav.png" alt="" />
                    <strong>Luxury Haven <div className="flex-col text-sm">Real Estate</div></strong></div></Link>
                </div>
                <div className="grid grid-cols-2 text-sm gap-x-20 gap-y-8 w-2/3  sm:grid-cols-4 mx-auto">
                    <div className="space-y-3">
                        ...
                        <ul className="space-y-1">
                            ...
                            <li><a rel="noopener noreferrer" href="#">Membership</a></li>
            ...
            <div className="p-5 text-sm text-center text-gray-400">© 2024 Luxury Haven Re. All rights reserved.</div>
        </footer>
    );
};
