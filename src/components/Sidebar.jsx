...
const Sidebar = () => {
    return (
        <div>
            <aside className="w-full p-6 sm:w-60 bg-gray-900 dark:bg-gray-50 text-gray-100 dark:text-gray-800">
	<nav className="space-y-8 text-sm">
		<div className="space-y-2">
			<h2 className="text-sm font-semibold tracking-widest uppercase text-gray-400 dark:text-gray-600">Getting Started</h2>
		...
		<div className="space-y-2">
			<h2 className="text-sm font-semibold tracking-widest uppercase text-gray-400 dark:text-gray-600">Dashboard</h2>
			<div className="flex flex-col space-y-1">
		...
		<div className="space-y-2">
			<h2 className="text-sm font-semibold tracking-widest uppercase text-gray-400 dark:text-gray-600">Pages</h2>
			<div className="flex flex-col space-y-1">
		...
		<div className="space-y-2">
			<h2 className="text-sm font-semibold tracking-widest uppercase text-gray-400 dark:text-gray-600">Misc</h2>
			<div className="flex flex-col space-y-1">
